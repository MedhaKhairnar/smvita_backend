      ...
      <CRow>
        <CCol>
          <CCard>
            ...
            >
              <CCardHeader>Course Registration</CCardHeader>
                ...
                <CFormGroup row>
                  ...
                  <CCol xs="6" md="6">
                    ...
                    {formik.touched.Fees && formik.errors.Fees ? (
                      <span style={{ color: "red" }}>{formik.errors.Fees}</span>
                    ) : null}
                ...
                <CFormGroup row>
                  ...
                  <CCol xs="6" md="6">
                    {fields.map((field, idx) => {
                      ...
                      value={formik.values.Syllabus[0].topic}
                    ...
                    />
                          <CTextarea
                            ...
                            value={formik.values.Syllabus[0].topic_desc}
                            {...formik.getFieldProps("Syllabus")}
                  ...
                  {formik.touched.Syllabus && formik.errors.Syllabus ? (
                    <span style={{ color: "red" }}>
                      {formik.errors.Syllabus}
                    </span>
                  ) : null}
                </CFormGroup>
                <CFormGroup row>
